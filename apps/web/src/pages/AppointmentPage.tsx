...
import { Container, IconInput, OrDivider, Toggle } from '@cora/ui'
            ...
            <div className="grid items-start gap-10 lg:grid-cols-2">
              <div className="rounded-2xl bg-cora-sky p-6 shadow-2xl sm:p-8">
                ...
                <form onSubmit={handleSearch} className="mt-6 space-y-4">
                  ...
                  />
                  <IconInput icon={<CardIcon />} placeholder="Insurance Provider" aria-label="Insurance Provider" />
...
function iconProps(size = 'h-5 w-5') {
  return { className: size, fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor', strokeWidth: 2, 'aria-hidden': true } as const
}

function SearchIcon() {
  return <svg {...iconProps()}><path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-4.35-4.35M17 11a6 6 0 11-12 0 6 6 0 0112 0z" /></svg>
}

function PinIcon() {
  return <svg {...iconProps()}><path strokeLinecap="round" strokeLinejoin="round" d="M12 21s7-6.16 7-11a7 7 0 10-14 0c0 4.84 7 11 7 11z" /><circle cx="12" cy="10" r="2.5" /></svg>
}

function LocateIcon() {
  return <svg {...iconProps()}><circle cx="12" cy="12" r="3" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 2v3M12 19v3M2 12h3M19 12h3" /></svg>
}

function CardIcon() {
  return <svg {...iconProps()}><rect x="3" y="5" width="18" height="14" rx="2" /><path strokeLinecap="round" d="M3 10h18" /></svg>
}

function PhysicalIcon() {
  return <svg {...iconProps('h-6 w-6')}><circle cx="9" cy="5" r="1.6" /><path strokeLinecap="round" strokeLinejoin="round" d="M5 21l3-6 4 1 3-3M8 15l-1-4 5-1 3 3 3-1" /></svg>
}

function OccupationalIcon() {
  return <svg {...iconProps('h-6 w-6')}><path strokeLinecap="round" strokeLinejoin="round" d="M7 11V6a2 2 0 114 0v5M11 11V5a2 2 0 114 0v6M15 11V7a2 2 0 114 0v6a6 6 0 01-6 6h-1a6 6 0 01-6-6v-2a2 2 0 114 0" /></svg>
}

function SpeechIcon() {
  return <svg {...iconProps('h-6 w-6')}><path strokeLinecap="round" strokeLinejoin="round" d="M4 5h16v11H8l-4 4V5z" /></svg>
}
